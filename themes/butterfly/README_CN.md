...
> 💡 **提示**: 如果您在中國大陸訪問 GitHub 速度較慢，可以使�?[Gitee 鏡像](https://gitee.com/immyw/hexo-theme-butterfly.git)
...
> ⚠️ **注意**: NPM 安裝方式僅支�?Hexo 5.0.0 及以上版�?
...
2. **安裝依賴**: 如果您尚未安�?pug �?stylus 渲染器，請執行：
...
- [x] **內建 404** - 美觀�?404 錯誤頁面
- [x] **Pjax 支援** - 流暢的頁面切換體�?

### 🎨 程式碼展�?
- [x] **語法高亮** - 內建多種主題（darker/pale night/light/ocean�?
- [x] **程式碼功�?* - 語言顯示/摺疊展開/複製按鈕/自動換行
- [x] **數學公式** - 支援 Mathjax �?Katex

### 💬 社交互動
- [x] **多元評論系統** - Disqus/Gitalk/Valine/Waline/Twikoo/Giscus/Artalk �?
- [x] **雙評論支�?* - 可同時啟用兩套評論系�?
...
- [x] **站長驗證** - 各大搜尋引擎驗證
- [x] **廣告支援** - Google AdSense/自訂廣告�?

### 🎪 視覺效果
- [x] **打字特效** - activate_power_mode 動畫
- [x] **背景特效** - 靜態彩帶/動態彩帶/飄帶效果/Canvas Nest
- [x] **滑鼠特效** - 煙花/愛心/文字點擊效果
- [x] **載入動畫** - Preloader �?pace.js 進度�?
- [x] **圖片效果** - Medium Zoom/Fancybox 圖片燈箱
- [x] **懶載�?* - 圖片延遲載入優化

### 🛠�?進階功能
- [x] **PWA 支援** - 漸進式網頁應用
- [x] **複製保護** - 可關閉文字複�?版權資訊追加
- [x] **主題定製** - 自訂網站配色方案
- [x] **圖表支援** - Mermaid 流程�?Chart.js 數據圖表
- [x] **音樂符號** - ABCJS 音樂記譜法支�?
- [x] **系列文章** - 系列文章組織功能
- [x] **Instantpage** - 頁面預載入加�?
- [x] **Snackbar** - 優雅的提示訊�?
...
我們相信，**開源的力量來自於每一個人的參�?*！無論您是開發者、設計師還是用戶，都可以�?Butterfly 主題的發展貢獻力量�?
...
- 📚 **學習使用�?* �?[官方文檔](https://butterfly.js.org/) - 詳細的使用指�?
- 💬 **即時討論�?* �?[Telegram 群組](https://t.me/bu2fly) - 與社群成員實時交�?

### 🎯 參與貢獻

想要�?Butterfly 變得更好嗎？我們歡迎您的任何形式的貢獻�?

- **🔧 代碼貢獻** - 修復 Bug、添加新功能、優化性能
- **📝 文檔完善** - 改進文檔、翻譯內容、撰寫教�?
- **🎨 設計建議** - UI/UX 改進、主題配色、圖示設�?
- **🧪 測試反饋** - 測試新功能、回報問題、提供使用體�?
- **💰 資金支援** - [贊助項目](https://buy.stripe.com/3cs6rP6YA91sbbG5kk) - 支持長期發展

## 📄 授權條款

本專案採�?[Apache 2.0](LICENSE) 授權條款�?

## 🙏 致敬與感�?

本主題基�?[hexo-theme-melody](https://github.com/Molunerfinn/hexo-theme-melody) 進行開發，感謝原作者的精彩創作為我們提供了靈感與基礎！
