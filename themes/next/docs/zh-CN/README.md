...
> NexT 是一款风格优雅的高质�?[Hexo](https://hexo.io) 主题，自点点滴滴中用爱雕琢而成�?
...
<br>
<br>
  更多 NexT 的例子参�?a href="https://github.com/next-theme/awesome-next#live-preview">这里</a>�?
</p>
...
安装完成后，�?Hexo 配置文件中将 `theme` 设置�?`next`�?
...
我们不推荐直接修�?NexT 主题的文件。因为这可能导致错误（例�?git merge 冲突），并且在升级主题时修改的文件可能丢失�?
...
配置这些插件非常简单。例如，你想要在你的站点中使�?`pjax` 插件，请进入 NexT 配置文件，启�?`pjax` 配置项：
...
第三方插件默认通过 [CDNJS](https://cdnjs.com) CDN 服务加载。我们也提供了其它的 CDN 服务供选择，包括著名的 [UNPKG](https://unpkg.com) �?[jsDelivr](https://www.jsdelivr.com)�?

例如，你想要使用 `unpkg` 代替 `cdnjs` 作为默认�?CDN 提供商，你需要在 NexT 配置文件中进行如下设置：
...
* **Discord 服务�?*：[加入我们�?Discord！](https://discord.gg/qmkgkY3jaG)
* **Gitter**：[加入我们�?Gitter 聊天！]
* **ChatGPT**: [NexT Mentor][gpt-url]

## 反馈

* 浏览 [Awesome NexT][awesome-next-url] 列表，与其它用户分享插件和教程�?
* 加入我们�?[GitHub discussions][discussions-url]�?
* 请花几秒钟来[添加或修正翻译][i18n-url]�?
* �?[GitHub Issues][issues-bug-url] 报告Bug�?
* �?[GitHub][issues-feat-url] 请求新的功能�?
* �?[受欢迎的 Feature request][feat-req-vote-url] 投票�?

## 贡献你的代码

我们欢迎你加�?NexT 的开发，贡献出你的一份力量。请看[开源贡献指南][contributing-document-url]�?🤗

你也可以随时向我们的[官方插件][official-plugins-url]提交 Issue �?Pull Request�?
