					...
					<tbody>
						<tr>
							<td colspan="2">
								...
								<p><img alt="" height="354" src=" /images/auto_save_image/2011/02/0828354hI.jpg" width="300" /> </p>
								<p>c) 点击Targer Portals中的Add</p>
								<p><img alt="" height="156" src=" /images/auto_save_image/2011/02/082836xHY.jpg" width="300" /> </p>
								<p>d) 填写Linux虚拟磁盘服务器IP,点击OK e) 再选择Targets</p>
								<p><img alt="" height="352" src=" /images/auto_save_image/2011/02/082836OMz.jpg" width="300" /></p>
								<p>f) 选中刚添加的IP点&ldquo;Log On&hellip;&rdquo;按钮</p>
								<p><img alt="" height="161" src=" /images/auto_save_image/2011/02/082836PkR.jpg" width="300" /> </p>
								<p>g) 启用Automatically restore this connection when the system boots(服务端操作，客户机无需操作) 设置完成后在我的电脑中显示多增加的磁盘即为映射出来的虚拟磁盘。</p>
								<p><img alt="" height="193" src=" /images/auto_save_image/2011/02/082837VL1.jpg" width="500" /></p>
							</td>
						</tr>
					</tbody>
				</table>
